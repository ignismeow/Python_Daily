...
btn_multiply = tk.Button(window, text="*", command=lambda: add_to_calculation("*"), width=5, font=('Arial', 14))
...
btn_leftpara = tk.Button(window, text="(", command=lambda: add_to_calculation("("), width=5, font=('Arial', 14))
btn_leftpara.grid(row=5, column=1)
btn_rightpara = tk.Button(window, text=")", command=lambda: add_to_calculation(")"), width=5, font=('Arial', 14))
btn_rightpara.grid(row=5, column=3)
btn_equals = tk.Button(window, text="=", command=evaluate_calculation, width=5, font=('Arial', 14))
btn_equals.grid(row=6, column=2)
btn_clear= tk.Button(window, text="C", command=clear_field, width=5, font=('Arial', 14))
